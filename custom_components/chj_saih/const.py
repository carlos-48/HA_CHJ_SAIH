...
CONF_RADIUS = "radius"
CONF_LATITUDE = "latitude" # Retained for now, as async_step_configure_global might still use it temporarily
CONF_LONGITUDE = "longitude" # Retained for now, as async_step_configure_global might still use it temporarily
CONF_LOCATION = "location" # New constant for combined location input
